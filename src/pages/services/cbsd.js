...
import img from "../../assets/Service/Detailservice9.png"; // Update with your cloud development illustration
          ...
          >
            <div className="space-y-4">
              <h2 className="text-5xl font-bold text-gray-800 leading-tight">
                Cloud-based
                <span className="block text-orange-800">Software Development</span>
              </h2>
              
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Cloud Infrastructure</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Data Storage</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Cloud Computing</span>
              </div>
            </div>
            
            <p className="text-gray-800 leading-relaxed text-lg bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              Pengembangan perangkat lunak yang berbasis cloud, memungkinkan perusahaan 
              untuk memanfaatkan infrastruktur cloud untuk hosting aplikasi, penyimpanan data, dan 
              proses komputasi.
            </p>
            ...
            <div className="space-y-4 bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800">
                Sistem akuntansi berbasis cloud, layanan backup data cloud, atau platform 
                kolaborasi yang berjalan di cloud.
              </p>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="absolute -top-6 left-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-800">Cloud Infrastructure</span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 right-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-orange-500 rounded-full"/>
                    <span className="text-sm text-gray-800">Cloud Computing</span>
                  </div>
                </div>
              </motion.div>
            </div>
