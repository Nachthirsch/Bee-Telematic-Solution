...
import img from "../../assets/Service/Detailservice7.png"; // Make sure to add your maintenance illustration
          ...
          >
            <div className="space-y-4">
              <h2 className="text-5xl font-bold text-gray-800 leading-tight">
                Software
                <span className="block text-orange-800">Maintenance & Support</span>
              </h2>
              
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Bug Fixes</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">System Updates</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Technical Support</span>
              </div>
            </div>
            
            <p className="text-gray-800 leading-relaxed text-lg bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              Perusahaan software house biasanya juga menawarkan layanan pemeliharaan 
              pasca-peluncuran, termasuk pembaruan sistem, perbaikan bug, penambahan 
              fitur, serta dukungan teknis untuk memastikan perangkat lunak berjalan 
              dengan lancar.
            </p>
            ...
            <div className="space-y-4 bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800">
                Memperbaiki bug, menambahkan modul baru, memperbarui keamanan, atau 
                mengoptimalkan kinerja perangkat lunak.
              </p>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="absolute -top-6 left-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-800">System Updates</span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 right-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-orange-500 rounded-full"/>
                    <span className="text-sm text-gray-800">Technical Support</span>
                  </div>
                </div>
              </motion.div>
            </div>
