...
import img from "../../assets/Service/Detailservice4.png";
          ...
          >
            <div className="space-y-4">
              <h2 className="text-5xl font-bold text-gray-800 leading-tight">
                UI/UX
                <span className="block text-orange-800">Design</span>
              </h2>
              
              <div className="flex gap-2">
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Wireframing</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Prototyping</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">User Research</span>
              </div>
            </div>
            
            <p className="text-gray-800 leading-relaxed text-lg bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              Membantu klien mendesain antarmuka pengguna yang intuitif dan menarik serta 
              meningkatkan pengalaman pengguna secara keseluruhan. Proses ini melibatkan 
              wireframing, prototyping, dan desain grafis yang fokus pada kenyamanan dan 
              kejelasan navigasi aplikasi.
            </p>
            ...
            <div className="space-y-4 bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800">
                Desain antarmuka untuk aplikasi mobile, desain halaman web, dan 
                pengalaman pengguna dalam perangkat lunak enterprise.
              </p>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="absolute -top-6 left-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-800">User Research</span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 right-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-orange-500 rounded-full"/>
                    <span className="text-sm text-gray-800">Prototyping</span>
                  </div>
                </div>
              </motion.div>
            </div>
