...
import img from "../../assets/Service/DetailService10.png"; // Update with your QA illustration
          ...
          >
            <div className="space-y-4">
              <h2 className="text-5xl font-bold text-gray-800 leading-tight">
                Testing &
                <span className="block text-orange-800">Quality Assurance</span>
              </h2>
              
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Functional Testing</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Performance Testing</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Security Testing</span>
                <span className="px-3 py-1 bg-orange-800 text-white rounded-full text-sm">Automated Testing</span>
              </div>
            </div>
            
            <p className="text-gray-800 leading-relaxed text-lg bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              Layanan untuk memastikan perangkat lunak bebas dari kesalahan dan memenuhi 
              standar kualitas yang ditetapkan. Ini mencakup pengujian fungsional, pengujian performa, 
              pengujian keamanan, dan otomatisasi pengujian.
            </p>
            ...
            <div className="space-y-4 bg-white/30 backdrop-blur-sm p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800">
                Uji keamanan aplikasi, uji beban sistem, atau pengujian otomatis untuk 
                memastikan perangkat lunak tetap stabil.
              </p>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="absolute -top-6 left-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-800">Quality Testing</span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 right-4 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-orange-500 rounded-full"/>
                    <span className="text-sm text-gray-800">Automated Testing</span>
                  </div>
                </div>
              </motion.div>
            </div>
