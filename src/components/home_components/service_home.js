      ...
      <div className="max-w mx-auto px-4 md:px-6 bg-amber-50 py-20 relative">
        <motion.section ref={ref} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="flex justify-center">
            <div ref={containerRef} className="flex flex-nowrap gap-6 overflow-hidden pb-4 cursor-grab active:cursor-grabbing touch-pan-x select-none" onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} onMouseLeave={handleMouseLeave} onMouseMove={handleMouseMove} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleEnd}>
                ...
                <div key={index} className="flex-none w-72 bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                  <div className="flex flex-col items-center">
                    ...
                    <Link to={card.path} className="w-full">
                      <button
                        className="w-full bg-orange-500 text-white px-6 py-2.5 rounded-full 
